...
public class TurnoServiceTest {
    ...
    void setUp() {
        ...
        turno = new Turno(1L, paciente, odontologo, null);
        turnoEntradaDto = new TurnoEntradaDto(1L, 1L, null);
    }

    @Test
    void deberiaRegistrarTurno() throws BadRequestException {
        when(pacienteServiceMock.buscarPacientePorId(1L)).thenReturn(new PacienteSalidaDto());
        when(odontologoServiceMock.buscarOdontologoPorId(1L)).thenReturn(new OdontologoSalidaDto());
